...
def getDynamicUncertainty(
    ...
    """
    Compute tubes from specific submission times to a custom end time. The
    custom_submission_time and stop_time is to control which submission to start the
    propagation with. If there are multiple submissions between custom_submission_time
    and stop_time, we propagate forward from each of them to the custom_end_time
    
    output_dir: the parent output directory, should contain the object id e.g.
                "uncertainty_changes/2012 DA14/
